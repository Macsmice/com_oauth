...
abstract class ComOauthModelOauth2s extends ComOauthModelOauths
{

	/**
	 * Maps aliases to domains.
	 */
	 ...
	 * @throws ComOauthLibsOauth2Exception
	 */
	...
	protected function _restserver($params) 
	{
		...
		{
			throw new ComOauthLibsOauth2Exception($result);
		}
		return $result;
	}
	...
	protected function makeRequest($url, $params, $ch=null) 
	{
		...
		if ($result === false) 
		{
			$e = new ComOauthLibsOauth2Exception(array(
