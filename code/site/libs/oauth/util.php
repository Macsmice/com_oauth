 ...
 */
class ComOauthLibsOauthUtil extends KObject 
{
	public function urlencode_rfc3986($input) 
	{
		if (is_array($input)) 
		{
			return array_map(array('ComOauthLibsOauthUtil', 'urlencode_rfc3986'), $input);
		} 
	 ...
	 */ 
	public function split_header($header, $only_allow_oauth_parameters = true) 
	{
		$pattern = '/(([-_a-z]*)=("([^"]*)"|([^,]*)),?)/';
		$offset = 0;
		$params = array();
	 ...
	 */  
	public function parse_parameters($input) 
	{
